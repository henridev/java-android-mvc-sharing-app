...
public class ContactListController {
    ...
    public ContactListController(ContactList contact_list){ this.contact_list = contact_list; }
    ...
    public int getIndex(Contact contact) { return contact_list.getIndex(contact); }
    ...
    public boolean hasContact(Contact contact){ return contact_list.hasContact(contact); }
